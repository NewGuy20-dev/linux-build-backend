...
curl -s http://localhost:3000/api/build/status/$BUILD_ID | jq '{status, createdAt, updatedAt, artifacts: (.artifacts | length), logs: (.logs | length)}'
